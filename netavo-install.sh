#!/bin/bash
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='netavo.conf'
CONFIGFOLDER='/root/.netavocore/'
COIN_DAEMON='/usr/local/bin/netavod'
COIN_CLI='/usr/local/bin/netavo-cli'
COIN_REPO='https://github.com/Netavo/NetavoCore/releases/download/v2.0.0.0/Netavo-Daemon-Ubuntu-x64_v2.0.0.tar.gz'
COIN_NAME='netavo'
COIN_PORT=15221
RPC_PORT=25001
...
addnode=37.1.210.137
addnode=37.1.216.134
EOF
}
